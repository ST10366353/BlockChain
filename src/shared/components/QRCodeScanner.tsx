...
import { Camera, Flashlight, RotateCcw, AlertTriangle } from 'lucide-react';
...
export const QRCodeScanner: React.FC<QRCodeScannerProps> = ({
  ...
  const extractQRData = (patterns: any[], _data: Uint8ClampedArray, _width: number, _height: number): string | null => {
