...
export function useHttpClient(baseURL: string = '') {
  ...
  const { handleAsyncError: _handleAsyncError } = useAPIErrorHandler()
  ...
  const handleResponse = React.useCallback(async <T>(
    response: Response
  ...
  const makeAuthenticatedRequest = React.useCallback(async <T>(
    url: string,
    options: HttpClientOptions = {}
  ): Promise<ApiResponse<T>> => {
    // First attempt
  ...
  const put = React.useCallback(<T = any>(
    url: string,
    data?: any,
    options: HttpClientOptions = {}
  ): Promise<ApiResponse<T>> => {
  ...
  const patch = React.useCallback(<T = any>(
    url: string,
    data?: any,
    options: HttpClientOptions = {}
  ): Promise<ApiResponse<T>> => {
  ...
  const delete_ = React.useCallback(<T = any>(
    url: string,
    options: HttpClientOptions = {}
  ): Promise<ApiResponse<T>> => {
...
export function useAPIClient(apiConfig: {
  ...
  const callAPI = React.useCallback(async <T = any>(
    endpoint: string,
    options: HttpClientOptions & {
...
export function useSessionAwareAPI() {
  ...
  const authenticatedCall = React.useCallback(async <T>(
    endpoint: string,
    options: any = {}
  ): Promise<T> => {
